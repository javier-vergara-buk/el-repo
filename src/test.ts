...
import { Plan, Pack, Component} from './main'; // Ajusta la ruta según la estructura de tu proyecto
...
describe('Pack Price Calculation', () => {
  it('should calculate the correct price for Mega Hogar Pack', () => {
      ...
      megaHogarPack.addComponent(hogarPack);
      megaHogarPack.addComponent(telefoniaPlan);
